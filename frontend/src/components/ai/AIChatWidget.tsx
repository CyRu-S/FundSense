...
export function AIChatWidget() {
    ...
    return (
        <>
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-24 right-6 z-50 w-[400px] h-[560px]">
                    <MagicCard
                        className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden h-full flex flex-col shadow-2xl"
                        glowColor="59, 130, 246"
                        enableStars={true}
                        enableTilt={false}
                    >
                        {/* Header */}
                        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 flex items-center gap-3 shrink-0">
